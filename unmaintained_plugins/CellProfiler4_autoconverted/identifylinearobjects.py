...
from cellprofiler_core.constants.measurement import COLTYPE_INTEGER, COLTYPE_FLOAT
...
class IdentifyLinearObjects(cpm.Module):
    ...
    def get_measurement_columns(self, pipeline):
        ...
        object_name = self.object_name.value
        return [(object_name, "Location_Center_X", COLTYPE_INTEGER),
                (object_name, "Location_Center_Y", COLTYPE_INTEGER),
                (object_name, M_ANGLE, COLTYPE_FLOAT),
                (object_name, "Number_Object_Number", COLTYPE_INTEGER),
                ("Image", "Count_%s" % object_name, COLTYPE_INTEGER)]
