...
import itkwasm
from itkwasm_morphological_contour_interpolation.morphological_contour_interpolation import morphological_contour_interpolation

__doc__ = """\
IdentifyPrimaryObjectsVolumetric
======================

**IdentifyPrimaryObjectsVolumetric** identifies biological objects of interest.
...
class IdentifyPrimaryObjectsVolumetric(
    ...
    module_name = "IdentifyPrimaryObjectsVolumetric"

    def __init__(self):
        self.threshold = threshold.Threshold()

        super(IdentifyPrimaryObjectsVolumetric, self).__init__()

    def volumetric(self):
        return True

    def create_settings(self):
        super(IdentifyPrimaryObjectsVolumetric, self).create_settings()
...
-  *{LIMIT_CHOICE_TEXT}*: {LIMIT_CHOICE_VALUE}""".format(
    ...
    def settings(self):
        settings = super(IdentifyPrimaryObjectsVolumetric, self).settings()
    ...
    def visible_settings(self):
        ...
        visible_settings += super(IdentifyPrimaryObjectsVolumetric, self).visible_settings()
    ...
    def run(self, workspace):
        ...
        # https://wasm.itk.org/en/latest/apidocs/itkwasm/itkwasm.image_from_array.html
        #x_data = itkwasm.image_from_array(x_data)
        # https://kitwaremedical.github.io/ITKContourInterpolation/py/docs/apidocs/itkwasm_morphological_contour_interpolation/itkwasm_morphological_contour_interpolation.morphological_contour_interpolation.html
        #y_data = morphological_contour_interpolation(x_data)

        # already handles volumetric
    ...
    def get_measurement_columns(self, pipeline):
        columns = super(IdentifyPrimaryObjectsVolumetric, self).get_measurement_columns(pipeline)
    ...
    def get_categories(self, pipeline, object_name):
        ...
        categories += super(IdentifyPrimaryObjectsVolumetric, self).get_categories(
    ...
    def get_measurements(self, pipeline, object_name, category):
        ...
        measurements += super(IdentifyPrimaryObjectsVolumetric, self).get_measurements(
