...
from cellprofiler_core.setting.text import ImageName, Pathname
...
class DoGNet(cellprofiler_core.module.Module):
    category = "Advanced"
    module_name = "DoGNet"
...
""")
    ...
    def run(self, workspace):
        ...
        output_image = cellprofiler_core.image.Image(y[0,0])
