...
import numpy as np
from cellprofiler_core.constants.measurement import COLTYPE_VARCHAR, C_METADATA, EXPERIMENT, R_PARENT
...
class ExportToCellH5(cpm.Module):
    ...
    def create_settings(self):
        ...
        self.file_name = cps.text.Filename(
        ...
        self.wants_to_choose_measurements = cps.Binary(
            ...
            """ % globals())
        self.measurements = MeasurementMultiChoice(
        ...
        self.add_objects_button = DoSomething(
    ...
    def run(self, workspace):
        ...
        with cellh5.cellh5write.CH5FileWriter(subfile_name, mode="a") as c5_file:
            ...
            feature_cols = filter(
                    lambda xxx: (xxx[0] not in (EXPERIMENT, "Image")) and
