...
class BlobDetection(cellprofiler_core.module.Module):
    ...
    def create_settings(self):
        ...
        self.y_name = cellprofiler_core.setting.text.ImageName(
            u"Output",
            u"BlobDetection",
            doc="""
        ...
        self.operation = cellprofiler_core.setting.choice.Choice(
            u"Operation",
            [
        ...
        self.minimum = cellprofiler_core.setting.text.Float(
            u"Minimum",
            1.0,
            doc="""
        ...
        self.maximum = cellprofiler_core.setting.text.Float(
            u"Maximum",
            50.0,
            doc="""
        ...
        self.ratio = cellprofiler_core.setting.text.Float(
            u"Ratio",
            1.6,
            doc="""
        ...
        self.count = cellprofiler_core.setting.text.Integer(
            u"Count",
            10,
            doc="""
        ...
        self.overlap = cellprofiler_core.setting.text.Float(
            u"Overlap",
            0.5,
            minval=0.0,
            maxval=1.0,
        ...
        self.scale = cellprofiler_core.setting.choice.Choice(
            u"Scale",
            [
        ...
        self.output = cellprofiler_core.setting.choice.Choice(
            u"Output",
            [
                u"Circles/Spheres",
                u"Centers"
